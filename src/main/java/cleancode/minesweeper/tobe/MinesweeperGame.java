...
public class MinesweeperGame {
    ...
    private static Integer[][] LAND_MINE_COUNTS = new Integer[8][10];
    private static boolean[][] LAND_MINES = new boolean[8][10];
    private static int GAME_STATUS = 0; // 0: 게임 중, 1: 승리, -1: 패배
